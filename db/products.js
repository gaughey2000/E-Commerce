...
const updateProductCatagory = (id, catagory) => DATA.query('UPDATE product SET catagory = $1 WHERE id = $2', [catagory, id])
const updateProductName = (id, name) => DATA.query('UPDATE product SET name = $1 WHERE id = $2', [name, id])

const insertProduct = (id, name, price, description, catagory) => DATA.query('INSERT INTO product (id, name, price, description, catagory) VALUES ($1, $2, $3, $4, $5)', [id, name, price, description, catagory])
const deleteProduct = (id) => DATA.query('DELETE FROM product WHERE id = $1', [id]) 
